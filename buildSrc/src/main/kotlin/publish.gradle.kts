        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/dagerler001/githubactionexample/")
                    ...
                    developers {
                        developer {
                            id.set("dagerler001")
                            name.set("dagerler001")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/dagerler001/githubactionexample.git")
                        developerConnection.set("scm:git:ssh://github.com/dagerler001/githubactionexample.git")
                        url.set("https://github.com/dagerler001/githubactionexample/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/dagerler001/githubactionexample/issues")
                    }
                }
            }
        }
